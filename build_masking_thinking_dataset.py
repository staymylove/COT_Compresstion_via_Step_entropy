...
async def generate_single_answer(client, question: str, thinking: dict, model_name: str) -> str:
    ...
    if thinking_mode == 0:
        try:
            ...
            dict1 = thinking
            thinking = score_mask_thinking_steps(dict1, 0.8)
...
async def evaluate_single_problem(
    ...
    async with sem:
        try:
            ...
            answer, mask_thinking = await generate_single_answer(client, prob["question"], prob['thinking_steps'],model_name)
            if answer is None:
                return None
...
async def main(debug: bool = False, resume: bool = False):
    ...
    problems = []
    # with open('/data/jianyuan/zeju_code/think_ada/dataset/deepscaler.json', 'r') as f:
    #     problem = json.load(f)
    #     for i in problem:
    #         problems.append({
    #             'question': i['problem'],
    ...
    #         })
    with open('/data/jianyuan/zeju_code/think_ada/inference_complete_thinking_cot_aime2025.jsonl', 'r') as f:
        for line in f:
    ...
    output_file = "/data/jianyuan/zeju_code/think_ada/inference_masking_thinking_cot_aime2025.jsonl"
